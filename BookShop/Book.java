...
public class Book {
    ...
    public static boolean editBook(Book newBook, Book oldBook) { // هذي الميثود موجودة عشان تستبدل بيانات الكتاب القديم بالبيانات الجديدة
        if (booksList.size() > 0) {
            int index = -1;
    ...
    public static void editBooks(Scanner scan) { // هذي الميثود تستخدم عشان تعدل في الكتب اللي سبق ضافها المستخدم
        boolean Menu = true;
        while (Menu) {
            System.out.println();
            ...
            switch (choiceNum1) {
                case 1: // الخيار هذا يعدل اسم الكتاب 
                    System.out.println("   --------------------");
                    System.out.print("* Enter Book Name : ");
                ...
                case 2: // الخيار هذا يعدل المؤلف
                    ...
                    break;
                case 3: // الخيار هذا يعدل السعر حق الكتاب
                    System.out.println("   --------------------");
                    System.out.print("* Enter Book Name : ");
    ...
    public static Book getBookByAuthor(String author) { // ميثود تشيك اذا المؤلف اللي ادخله المستخدم متوفر في الاراي ليست
    ...
    public static Book getBookByName(String name) { // ميثود تشيك اذا اسم الكتاب اللي ادخله المستخدم متوفر في الاراي ليست
    ...
    public static void deleteThisBook(Scanner scanner) {  // ميثود لحذف الكتب 
        System.out.print("* Enter Book Name : ");
    ...
    public static void searchBook(Scanner scanner) { // ميثود تبحث عن الكتاب اللي يبغاه المستخدم
        ...
        while (Menu) {
            ...
            switch (choiceNum) {
                ...
                case 1: // الخيار ذا يخلي المستخدم يبحث عن كتاب عن طريق الاسم
                    ...
                    break;
                case 2: // تخلي المستخدم يختار الكتاب عن طريق المؤلف
    ...
    public static void existApp() { // ينهي البرنامج
        System.out.println("\n   ---- Finsh Program ----");
        System.exit(0);
    }
